    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Thêm bảng lương</h4>
              <form action = "{{route('salaryStore')}}" method="post">
                ...
                <div class="form-group">
                    <label for="mabangchamcong">Mã bảng chấm công</label>
                    <input type="text" class="form-control" name= "mabangchamcong" >
                  </div>
                  <div class="form-group">
                    <label for="luonghanhchinh">Lương hành chính</label>
                    <input type="text" class="form-control" name= "luonghanhchinh" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name= "khautru" >
                  </div>
                  <div class="form-group">
                    <label for="thuclinh">Thực lĩnh</label>
                    <input type="text" class="form-control" name= "thuclinh" >
                  </div>
